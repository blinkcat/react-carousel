    ...
    <div className="app">
      <div className="center">
        <Carousel
          ...
          className={direction === 'horizontal' ? 'demo' : 'demo vertical'}
          draggable={draggable}
      ...
      <h2>lift effect</h2>
      <div className="center">
        <Carousel effect="lift" className="lift-demo" loop extra={<Navigation />}>
          {[1, 2, 3, 4, 5, 6].map((v) => (
            <PlaceHolder key={v}>{v}</PlaceHolder>
          ))}
        </Carousel>
      </div>
      <h2>fade effect</h2>
      <div className="center">
        <Carousel effect="fade" className="fade-demo" loop extra={<Navigation />}>
          {[1, 2, 3, 4, 5, 6].map((v) => (
            <PlaceHolder key={v}>{v}</PlaceHolder>
          ))}
        </Carousel>
      ...
      <h2>stack effect</h2>
      <div className="center">
        <Carousel effect="stack" className="stack-demo" loop cellAlign="left">
          {[1, 2, 3, 4, 5, 6].map((v) => (
            <PlaceHolder key={v}>{v}</PlaceHolder>
          ))}
        </Carousel>
